...
public class WebCashPatricsAdditionalArbitaryEndToEndTest extends EndToEndTests{
    public void testWebCashCase() throws Exception {
    	Date now = new Date();
		clean();

		copyFileToInfolder(now, "WK_TEST_2.txt");
		copyFileToInfolder(now, "WK_TEST_2_people.txt");
